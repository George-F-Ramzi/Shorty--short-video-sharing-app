...
CREATE TABLE `video` (
  ...
  `thumbnailId` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `urlId` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `video_userId_fkey` (`userId`),
  FULLTEXT KEY `video_details_idx` (`details`),
