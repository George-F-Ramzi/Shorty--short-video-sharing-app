...
CREATE TABLE `followers` (
  ...
  `beenFollowingId` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`beenFollowingId`,`followingId`),
  KEY `followers_followingId_fkey` (`followingId`),
  CONSTRAINT `followers_beenFollowingId_fkey` FOREIGN KEY (`beenFollowingId`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2022-12-14 16:55:03
